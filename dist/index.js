...
const Message = (props) => {
    ...
    const innerWrap = (0, vue_1.h)('div', { class: styles['inner-wrap'] }, [
        (0, vue_1.h)(Icon[type], { class: styles['icon'] }),
        (0, vue_1.h)('div', { class: styles['message'] }, [(0, vue_1.h)('span', null, message)])
    ]);
    setTimeout(() => {
    ...
    return (0, vue_1.h)('div', { class: styles['wrap'] }, [innerWrap]);
};
//@ts-ignore
exports.message = {};
const types = [
...
types.forEach(type => {
    exports.message[type] = (content, duration = 2500) => {
        return new Promise(resolve => {
            ...
            requestAnimationFrame(() => {
                ...
                (0, vue_1.render)(messageVNode, fragment);
