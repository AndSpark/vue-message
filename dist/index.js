...
function FaSolidTimesCircle(props) {
    return h('svg', Object.assign({ width: '1em', height: '1em', viewBox: '0 0 512 512', style: { color: '#ff6347' } }, props), [
        h('path', {
...
const LoadingIcon = (props) => {
    return h('svg', Object.assign({ viewBox: '0 0 512 512', width: '1em', height: '1em', style: { color: '#6495ed' } }, props), [
        h('path', {
            fill: 'currentColor',
...
function FaSolidCheckCircle(props) {
    return h('svg', Object.assign({ width: '1em', height: '1em', viewBox: '0 0 512 512', style: { color: '#39c5bb' } }, props), [
        h('path', {
...
function FaSolidInfoCircle(props) {
    return h('svg', Object.assign({ width: '1em', height: '1em', viewBox: '0 0 512 512', style: { color: '#6495ed' } }, props), [
        h('path', {
...
function FaSolidExclamationCircle(props) {
    return h('svg', Object.assign({ width: '1em', height: '1em', viewBox: '0 0 512 512', style: { color: '#ffc107' } }, props), [
        h('path', {
    ...
    message[type] = (content, duration = 2500) => {
        return new Promise(resolve => {
            ...
            requestAnimationFrame(() => {
                var _a;
                let message;
                const configDuration = typeof content === 'string'
                    ? duration
                    : (_a = content.duration) !== null && _a !== void 0
                        ? _a
                        : duration;
                const reallyduration = typeof configDuration === 'function' ? configDuration() : configDuration;
